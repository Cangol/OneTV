...
/**
 * @Description UserFavorite.java 
 * @author Cangol
 * @date 2013-9-8
 */
@DatabaseTable(tableName="user_favorite")
public class UserFavorite  implements java.io.Serializable {
	...
	/**
	 * Creates a new instance of UserFollow. 
	 * @param _id
	 * @param id
	 * @param videoId
	 * @param videoName
	 * @param lastPlayTime
	 */
	public UserFavorite(Integer _id, String id, String videoId, String videoName,
			String lastPlayTime) {
		super();
		this._id = _id;
		this.id = id;
